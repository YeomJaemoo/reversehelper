...
# Attempt to import aruco module and handle exceptions
try:
    parameters = cv2.aruco.DetectorParameters_create()
    aruco_dict = cv2.aruco.Dictionary_get(cv2.aruco.DICT_5X5_50)
except AttributeError:
    st.error("Aruco module not found. Make sure opencv-contrib-python is installed.")
...
while True:
    ...
    try:
        ...
        st.error(f"Error processing Aruco markers: {e}")
